...
<template>
  <div
    class="result-list overflow-y-auto bg-white dark:bg-[#1A1A2E]"
    role="listbox"
    aria-label="提示词列表"
  >
    <!-- 结果列表 -->
    ...
    <div
      ...
      class="empty-state py-10 text-center"
    >
      <div
        class="text-3xl mb-2 opacity-40"
        aria-hidden="true"
      >
        🔍
      </div>
      ...
      <p class="text-xs text-[#71717A]/70 mt-1.5">
        按 Ctrl+N 创建新提示词
      </p>
    </div>
  </div>
